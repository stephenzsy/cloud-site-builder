...
function PageSectionSlot({
  ...
  if (section.attributes?.templateId === "hero-section") {
    ...
    return (
      <section className="w-full h-[400px] border rounded-xl p-10 grid items-center justify-center bg-gradient-to-tr from-brand_analogous_ccw_1-200 via-brand-300 to-brand_analogous_cw_1-100">
